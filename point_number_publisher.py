...
def numbercallback(self,data):
    try:
        ...
        self.__init__
        find_circle(cv_image,rec_contour)
    except CvBridgeError as e:
        print(e)


if __name__ == '__main__':
    rospy.init_node('point_number_pub',anonymous=True)
    number_publisher=rospy.Publisher('/Braille',int)
    bridge=CvBridge()
    image_sub = rospy.Subscriber('/Webcam',Image,numbercallback)
    rospy.spin()